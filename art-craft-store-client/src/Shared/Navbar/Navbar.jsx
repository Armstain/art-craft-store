...
const Navbar = () => {
    ...
    const Links = (
        <>
            ...
            <li><NavLink className={({ isActive }) => isActive ? 'font-bold' : ''} to="/allItems">All items</NavLink></li>
            <li><NavLink className={({ isActive }) => isActive ? 'font-bold' : ''} to="/addItems">Add items</NavLink></li>
            <li><NavLink className={({ isActive }) => isActive ? 'font-bold' : ''} to="/UserItemList">My List</NavLink></li>
        </>
    );
        ...
        <div>
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-xl">CraftedCanvas</a>
                </div>
                        ...
                        <div className="dropdown dropdown-end">
                            <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar tooltip tooltip-left z-30" data-tip={user.displayName || 'User Profile'}>
                                <div className="w-10 rounded-full">
                                    <img alt="User Avatar" src={user?.photoURL || 'https://api.lorem.space/image/face?hash=33791'} />
                                </div>
                            </div>
                            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-20 p-2 shadow bg-base-100 rounded-box w-52">
